...
python3 -m examples/python/nixl_api_example.py
python3 -m examples/python/partial_md_example.py
python3 -m examples/python/partial_md_example.py --etcd
pytest test/python
...
python3 -m examples/python/blocking_send_recv_example.py --mode="target" --ip=127.0.0.1 --port="$blocking_send_recv_port"&
sleep 5
python3 -m examples/python/blocking_send_recv_example.py --mode="initiator" --ip=127.0.0.1 --port="$blocking_send_recv_port"

python3 -m examples/python/query_mem_example.py
