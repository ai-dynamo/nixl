...
curl --proto '=https' --tlsv1.2 -sSf --retry 10 --connect-timeout 20 --retry-delay 10 --retry-all-errors --fail --output rustup-init https://static.rust-lang.org/rustup/dist/${ARCH}-unknown-linux-gnu/rustup-init
chmod +x rustup-init
