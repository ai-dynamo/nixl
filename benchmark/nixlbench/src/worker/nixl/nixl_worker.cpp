...
xferBenchNixlWorker::xferBenchNixlWorker(int *argc, char ***argv, std::vector<std::string> devices)
    ...
    if (0 == xferBenchConfig::backend.compare(XFERBENCH_BACKEND_UCX) ||
        ...
        0 == xferBenchConfig::backend.compare(XFERBENCH_BACKEND_UCCL_P2P) ||
    ...
    } else if (0 == xferBenchConfig::backend.compare(XFERBENCH_BACKEND_UCCL_P2P)) {
        std::cout << "UCCL_P2P backend" << std::endl;
