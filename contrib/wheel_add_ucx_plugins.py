...
def main():
    ...
    parser.add_argument("--ucx-lib-dir", type=str, help="Path to the UCX lib directory", default="/usr/lib64")
    parser.add_argument("wheel", type=str, nargs="+", help="Path to one or more wheel files")
