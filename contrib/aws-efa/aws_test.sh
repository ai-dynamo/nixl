...
usage() {
    ...
    echo "  CONTAINER_IMAGE   - Container image to use (default: nvcr.io/nvidia/cuda-dl-base:25.02-cuda12.8-devel-ubuntu24.04)"
...
test_cmd="$1"
export CONTAINER_IMAGE=${CONTAINER_IMAGE:-"nvcr.io/nvidia/cuda-dl-base:25.02-cuda12.8-devel-ubuntu24.04"}
