...
usage() {
    ...
    echo "  CONTAINER_IMAGE   - Container image to use (default: nvcr.io/nvidia/cuda-dl-base:26.08-cuda13.4-devel-ubuntu24.04)"
...
export CONTAINER_IMAGE=${CONTAINER_IMAGE:-"nvcr.io/nvidia/cuda-dl-base:26.08-cuda13.4-devel-ubuntu24.04"}
