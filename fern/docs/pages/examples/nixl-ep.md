...
NIXL-EP is included in the NIXL binary distribution.
...
The following Python-like pseudocode summarizes the API flow. See the [complete NIXL-EP example](https://github.com/ai-dynamo/nixl/tree/main/examples/device/ep) for the runnable implementation across its multiple files.

```text title="Python-like pseudocode"
import nixl_ep
