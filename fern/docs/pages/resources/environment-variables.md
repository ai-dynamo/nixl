...
| `NIXL_LOG_FILE_SIZE` | At least `4K`, optionally suffixed `K`, `M` or `G` | Not set (no limit) | Bounds `NIXL_LOG_FILE`, keeping the newest records plus one rotated generation. |
