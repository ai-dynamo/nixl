## UCCL P2P Backend Plugin [Preview]
...
2. Build NIXL using regular method as in [README](https://github.com/ai-dynamo/nixl/blob/main/README.md) ensuring `disable_uccl_p2p_backend` is set to `false`.
...
Example Usage to create a NIXL agent with UCCL P2P engine:
    ...
    ```python
    config = nixl_agent_config(backends=["UCCL_P2P"])
