...
struct docaXferReqGpu {
    ...
    struct doca_gpu_dev_verbs_qp *qp_data;
    struct doca_gpu_dev_verbs_qp *qp_notif;
...
struct nixlDocaRdmaQp {
    struct doca_gpu_verbs_qp_hl *qp_data_hl;
    struct doca_gpu_dev_verbs_qp *qp_data_gpu;
    uint32_t qpn_data;
    uint32_t rqpn_data;
    uint32_t remote_gid_data;

    struct doca_gpu_verbs_qp_hl *qp_notif_hl;
    struct doca_gpu_dev_verbs_qp *qp_notif_gpu;
    uint32_t qpn_notif;
    uint32_t rqpn_notif;
