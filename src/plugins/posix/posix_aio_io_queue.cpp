...
nixl_status_t
nixlPosixIOQueueAIO::submitBatch(uint32_t to_submit, uint32_t &submitted_ios) {
...
nixl_status_t
nixlPosixIOQueueAIO::checkCompleted(uint32_t &completed_ios) {
    NIXL_ASSERT(!ios_in_flight_.empty());
