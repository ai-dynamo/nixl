...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_NIXL_CUDA_CUDA_COMMON_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_NIXL_CUDA_CUDA_COMMON_H
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_NIXL_CUDA_CUDA_COMMON_H
