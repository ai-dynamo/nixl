...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_CONTROL_CHANNEL_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_CONTROL_CHANNEL_H
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_CONTROL_CHANNEL_H
