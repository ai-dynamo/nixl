...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_RXDM_DXS_STUB_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_RXDM_DXS_STUB_H
...
public:
    ...
    RegBuf(int fd, size_t size) override {
        return dxs::kInvalidRegistration;
    }

    absl::Status
    DeregBuf(dxs::Reg reg_handle) override {
        return absl::OkStatus();
    }
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_RXDM_DXS_STUB_H
