...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_PARAMS_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_PARAMS_H
...
/* Number of worker threads that service the control channel. */
...
/*
 * Optionally specifies connection information for NCCL bootstrap network, used by ranks to find
 * each other during communicator initialization. Can be used to manually set the rendezvous point,
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_PARAMS_H
