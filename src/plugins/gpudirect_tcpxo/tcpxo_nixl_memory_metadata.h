...
#ifndef GPUDIRECT_TCPXO_TCPXO_NIXL_MEMORY_METADATA_H_
#define GPUDIRECT_TCPXO_TCPXO_NIXL_MEMORY_METADATA_H_
...
#endif // GPUDIRECT_TCPXO_TCPXO_NIXL_MEMORY_METADATA_H_
