...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_MPMC_QUEUE_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_MPMC_QUEUE_H
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_MPMC_QUEUE_H
