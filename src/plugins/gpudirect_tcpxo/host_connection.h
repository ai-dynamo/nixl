...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_HOST_CONNECTION_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_HOST_CONNECTION_H
...
public:
     ...
     *   workload is probably not set up correctly in some bizarre way.
     */
    absl::Status
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_HOST_CONNECTION_H
