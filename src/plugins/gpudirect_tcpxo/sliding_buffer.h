...
#ifndef NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_SLIDING_BUFFER_H
#define NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_SLIDING_BUFFER_H
...
#endif // NIXL_SRC_PLUGINS_GPUDIRECT_TCPXO_SLIDING_BUFFER_H
