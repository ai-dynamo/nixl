...
using prometheus_mp_exporter_plugin_t =
    nixlTelemetryPluginCreator<nixlTelemetryPrometheusMpExporter>;
...
nixl_telemetry_plugin_init() {
    return prometheus_mp_exporter_plugin_t::create(
        nixl_telemetry_plugin_api_version::V2, "prometheus_mp", "1.0.0");
}
