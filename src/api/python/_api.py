...
class nixl_agent:
    def __init__(
        ...
        self.nixl_mems = {
            ...
            "cpu": nixlBind.DRAM_SEG,  # to be deprecated
            "cuda": nixlBind.VRAM_SEG,  # to be deprecated
        }
        self.nixl_ops = {
    ...
    def get_xfer_descs(
        ...
        if isinstance(descs, nixlBind.nixlXferDList):
            ...
            if descs.is_contiguous():
                mem_type = "DRAM" if descs.get_device() == -1 else "VRAM"
            ...
            mem_type = "DRAM" if descs[0].get_device() == -1 else "VRAM"
