 ...
 * same-endian hosts.
 */
#ifndef NIXL_SRC_CORE_BACKENDS_TCPSTORE_CLIENT_H
#define NIXL_SRC_CORE_BACKENDS_TCPSTORE_CLIENT_H
...
#endif // NIXL_SRC_CORE_BACKENDS_TCPSTORE_CLIENT_H
