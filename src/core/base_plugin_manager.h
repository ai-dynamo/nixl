...
protected:
    ...
    void *pluginInterface_;

    basePluginHandle(std::unique_ptr<void, dlHandleDeleter> handle, void *pluginInterface);
};
...
protected:
     ...
     * Returns PluginLoadResult with handle and interface pointer on success
     */
