...
resolve(const char* name)
{
    ...
    if (!handle) {
        std::cerr
            << "nixl error: libnixl_capi.so not found. "
...
{
    using fn_t = nixl_capi_status_t (*)(const char*, const nixl_capi_agent_config_t*, nixl_capi_agent_t*);
...
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_reg_dlist_t, void**, size_t*, nixl_capi_opt_args_t);
    static fn_t real = (fn_t)resolve("nixl_capi_get_local_partial_md");
    return real(agent, descs, data, len, opt_args);
}

nixl_capi_status_t
nixl_capi_load_remote_md(nixl_capi_agent_t agent,
                         const void* data,
                         size_t len,
                         char** agent_name)
{
...
nixl_capi_send_local_partial_md(nixl_capi_agent_t agent,
                                ...
                                nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_reg_dlist_t, nixl_capi_opt_args_t);
    static fn_t real = (fn_t)resolve("nixl_capi_send_local_partial_md");
    return real(agent, descs, opt_args);
}

nixl_capi_status_t
nixl_capi_invalidate_remote_md(nixl_capi_agent_t agent,
...
nixl_capi_status_t
nixl_capi_invalidate_local_md(nixl_capi_agent_t agent,
                              nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_opt_args_t);
...
nixl_capi_prep_xfer_dlist(nixl_capi_agent_t agent,
                          ...
                          nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, const char*, nixl_capi_xfer_dlist_t, nixl_capi_xfer_dlist_handle_t*, nixl_capi_opt_args_t);
...
nixl_capi_make_xfer_req(nixl_capi_agent_t agent,
                        ...
                        nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_op_t, nixl_capi_xfer_dlist_handle_t, const int*, size_t, nixl_capi_xfer_dlist_handle_t, const int*, size_t, nixl_capi_xfer_req_t*, nixl_capi_opt_args_t);
    static fn_t real = (fn_t)resolve("nixl_capi_make_xfer_req");
    return real(agent, operation, local_descs, local_indices, local_indices_count, remote_descs, remote_indices, remote_indices_count, req_hndl, opt_args);
}
...
nixl_capi_status_t
nixl_capi_get_available_plugins(nixl_capi_agent_t agent,
...
nixl_capi_status_t
nixl_capi_string_list_get(nixl_capi_string_list_t list,
                          size_t index,
                          const char** str)
{
...
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, const char*, nixl_capi_mem_list_t*, nixl_capi_params_t*);
...
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, const char*, nixl_capi_params_t, nixl_capi_backend_t*);
...
nixl_capi_get_backend_params(nixl_capi_agent_t agent,
                             ...
                             nixl_capi_params_t* params)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_backend_t, nixl_capi_mem_list_t*, nixl_capi_params_t*);
...
nixl_capi_status_t
nixl_capi_opt_args_add_backend(nixl_capi_opt_args_t args,
                               nixl_capi_backend_t backend)
{
...
nixl_capi_status_t
nixl_capi_opt_args_set_notif_msg(nixl_capi_opt_args_t args,
                                 const void* data,
                                 size_t len)
{
...
nixl_capi_status_t
nixl_capi_opt_args_get_notif_msg(nixl_capi_opt_args_t args,
                                 void** data,
                                 size_t* len)
{
...
nixl_capi_status_t
nixl_capi_opt_args_set_skip_desc_merge(nixl_capi_opt_args_t args,
                                       bool skip_merge)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_opt_args_t, bool);
...
nixl_capi_status_t
nixl_capi_opt_args_get_skip_desc_merge(nixl_capi_opt_args_t args,
                                       bool* skip_merge)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_opt_args_t, bool*);
...
nixl_capi_status_t
nixl_capi_opt_args_set_ip_addr(nixl_capi_opt_args_t args,
                               const char* ip_addr)
{
...
nixl_capi_status_t
nixl_capi_params_add(nixl_capi_params_t params,
                     const char* key,
                     const char* value)
{
...
nixl_capi_status_t
nixl_capi_params_create_iterator(nixl_capi_params_t params,
                                 nixl_capi_param_iter_t* iter)
{
...
nixl_capi_params_iterator_next(nixl_capi_param_iter_t iter,
                               ...
                               bool* has_next)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_param_iter_t, const char**, const char**, bool*);
...
nixl_capi_status_t
nixl_capi_mem_list_get(nixl_capi_mem_list_t list,
                       size_t index,
                       nixl_capi_mem_type_t* mem_type)
{
...
nixl_capi_status_t
nixl_capi_create_xfer_dlist(nixl_capi_mem_type_t mem_type,
                            nixl_capi_xfer_dlist_t* dlist)
{
...
nixl_capi_status_t
nixl_capi_xfer_dlist_get_type(nixl_capi_xfer_dlist_t dlist,
                              nixl_capi_mem_type_t* mem_type)
{
...
nixl_capi_status_t
nixl_capi_create_reg_dlist(nixl_capi_mem_type_t mem_type,
...
nixl_capi_reg_dlist_add_desc(nixl_capi_reg_dlist_t dlist,
                             ...
                             size_t metadata_len)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_reg_dlist_t, uintptr_t, size_t, uint64_t, const void*, size_t);
...
nixl_capi_status_t
nixl_capi_reg_dlist_get_type(nixl_capi_reg_dlist_t dlist,
                             nixl_capi_mem_type_t* mem_type)
{
...
nixl_capi_create_xfer_req(nixl_capi_agent_t agent,
                          ...
                          nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_op_t, nixl_capi_xfer_dlist_t, nixl_capi_xfer_dlist_t, const char*, nixl_capi_xfer_req_t*, nixl_capi_opt_args_t);
...
nixl_capi_post_xfer_req(nixl_capi_agent_t agent,
                        ...
                        nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_req_t, nixl_capi_opt_args_t);
    static fn_t real = (fn_t)resolve("nixl_capi_post_xfer_req");
    return real(agent, req_hndl, opt_args);
}

nixl_capi_status_t
nixl_capi_get_xfer_status(nixl_capi_agent_t agent,
                          nixl_capi_xfer_req_t req_hndl)
{
...
nixl_capi_query_xfer_backend(nixl_capi_agent_t agent,
                             ...
                             nixl_capi_backend_t* backend)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_req_t, nixl_capi_backend_t*);
...
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_req_t, nixl_capi_opt_args_t, int64_t*, int64_t*, nixl_capi_cost_t*);
...
nixl_capi_get_notifs(nixl_capi_agent_t agent,
                     ...
                     nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_notif_map_t, nixl_capi_opt_args_t);
...
nixl_capi_gen_notif(nixl_capi_agent_t agent,
                    ...
                    nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, const char*, const void*, size_t, nixl_capi_opt_args_t);
...
nixl_capi_status_t
nixl_capi_notif_map_get_agent_at(nixl_capi_notif_map_t map,
                                 size_t index,
                                 const char** agent_name)
{
...
nixl_capi_notif_map_get_notif(nixl_capi_notif_map_t map,
                              ...
                              size_t* len)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_notif_map_t, const char*, size_t, const void**, size_t*);
...
nixl_capi_query_mem(nixl_capi_agent_t agent,
                    ...
                    nixl_capi_opt_args_t opt_args)
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_reg_dlist_t, nixl_capi_query_resp_list_t, nixl_capi_opt_args_t);
...
{
    using fn_t = nixl_capi_status_t (*)(nixl_capi_agent_t, nixl_capi_xfer_req_t, nixl_capi_xfer_telemetry_t);
