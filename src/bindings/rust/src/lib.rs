...
use bindings::{
    ...
    nixl_capi_get_xfer_status, nixl_capi_invalidate_local_md, nixl_capi_invalidate_remote_md,
    nixl_capi_load_remote_md, nixl_capi_mem_list_get, nixl_capi_mem_list_is_empty,
    nixl_capi_mem_list_size, nixl_capi_mem_type_t, nixl_capi_mem_type_to_string,
    ...
    nixl_capi_reg_dlist_resize, nixl_capi_register_mem, nixl_capi_send_local_md,
