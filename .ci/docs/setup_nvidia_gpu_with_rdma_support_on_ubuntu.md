...
sudo apt-get update
sudo apt install nvidia-kernel-open-<version> nvidia-driver-<version>  # e.g., nvidia-kernel-open-575
sudo reboot
```
...
### 4. **Enable Multi-Process Service (MPS)**
