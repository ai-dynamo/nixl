...
namespace {
    ...
    TEST_F(ControlChannelTest, SendIdentityMessage) {
        ...
        EXPECT_TRUE(received.WaitForNotificationWithTimeout(kDefaultNotificationTimeout));
    ...
    TEST_F(ControlChannelTest, SendMaxMessageSize) {
        ...
        ASSERT_TRUE(channel1_->ScheduleSend(handle, std::move(msg)).ok());
        EXPECT_TRUE(received.WaitForNotificationWithTimeout(kMaxMessageTransmissionTimeout));
    ...
    TEST_F(ControlChannelTest, BidirectionalSendMaxMessageSize) {
        ...
        EXPECT_TRUE(received1.WaitForNotificationWithTimeout(kMaxMessageTransmissionTimeout));
        EXPECT_TRUE(received2.WaitForNotificationWithTimeout(kMaxMessageTransmissionTimeout));
    ...
    TEST_F(ControlChannelTest, MultiThreadedSend) {
        ...
        EXPECT_TRUE(all_received.WaitForNotificationWithTimeout(kMaxMessageTransmissionTimeout));
