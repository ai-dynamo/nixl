...
#python /swgwork/eshukrun/nixl/tools/perf/cli.py ct-perftest /swgwork/eshukrun/nixl/tools/perf/test/test.yaml --verify-buffers 

#echo "Testing multi-custom traffic perftest"
python /swgwork/eshukrun/nixl/tools/perf/cli.py sequential-ct-perftest /swgwork/eshukrun/nixl/tools/perf/test/test_multi.yaml --verify-buffers 
