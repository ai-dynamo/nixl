...
<Note>
Timestamps are recorded after the operation completes, not when it starts. Selective telemetry per category is not supported -- all events are enabled or disabled together.
</Note>
