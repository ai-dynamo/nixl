...
| `agent_tx_bytes` | `NIXL_TELEMETRY_TRANSFER` | Yes | bytes | bytes transmitted by the agent per TX requests |
| `agent_rx_bytes` | `NIXL_TELEMETRY_TRANSFER` | Yes | bytes | bytes received by the agent per RX requests |
