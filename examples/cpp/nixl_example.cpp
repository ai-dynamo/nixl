...
main(int argc, char **argv) {
    ...
    CHECK_NIXL_ERROR_AGENT(ret1, "Failed to get plugin params", agent1);
    CHECK_NIXL_ERROR_AGENT(ret2, "Failed to get plugin params", agent2);
    ...
    CHECK_NIXL_ERROR_AGENT(ret1, "Failed to create backend", agent1);
    CHECK_NIXL_ERROR_AGENT(ret2, "Failed to create backend", agent2);

    ret1 = A1.getBackendParams(bknd1, mems1, init1);
    ret2 = A2.getBackendParams(bknd2, mems2, init2);

    CHECK_NIXL_ERROR_AGENT(ret1, "Failed to get backend params", agent1);
    CHECK_NIXL_ERROR_AGENT(ret2, "Failed to get backend params", agent2);
    ...
    CHECK_NIXL_ERROR_AGENT((status > NIXL_IN_PROG), "Failed to post Xfer Req", agent1);
    ...
    CHECK_NIXL_ERROR_AGENT(ret1, "F ailed to deregister memory", agent1);
