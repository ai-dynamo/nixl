...
from nixl_memory_utils import write_uint64, read_uint64, write_data, read_data
...
def receiver_process():
    ...
    _sender_tail_descs = retrieve_descriptors(agent, "sender_tail_desc")
...
def sender_process():
    ...
    _receiver_head_descs = retrieve_descriptors(agent, "receiver_head_desc")
